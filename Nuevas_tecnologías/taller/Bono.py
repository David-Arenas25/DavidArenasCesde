...
if ing == "si":
    ...
    print(f"""
        personas estratp 1 {personEstratoUno}
        ...
        cantidad de personas con 1 o dos hijos {personasUnoDosHijos}
        cantidad de personas con 3 o mas hijos {personasTresHijos}
        ...
        total dinero entregado a beneficiaros 3 o más hijos {totalTresHijos}
